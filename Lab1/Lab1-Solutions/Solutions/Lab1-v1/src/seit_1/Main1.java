...
public class Main1 {
	...
	public static void main(String[] args)	{
		Person	w1 = new Person("aaa", 1, 2, 1991); w1.setType(2);
		Person	w2 = new Person("bbb", 3, 4, 1993); w2.setType(2);
		Person	w3 = new Person("ccc", 5, 6, 1995); w3.setType(2);
	
		Person	b1 = new Person("ddd", 7, 8, 1997); b1.setType(1);
		b1.initWorker();
		
		Person	b2 = new Person("eee", 9,10, 1999); b2.setType(1);
		b2.initWorker();
